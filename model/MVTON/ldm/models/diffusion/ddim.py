...
from model.MVTON.ldm.modules.diffusionmodules.util import make_ddim_sampling_parameters, make_ddim_timesteps, noise_like, \
    extract_into_tensor
...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      x_T=None, down_samples=None, ddim_use_original_steps=False,
        ...
        for i, step in enumerate(iterator):
            ...
            outs = self.p_sample_ddim(img, cond, ts, index=index, use_original_steps=ddim_use_original_steps,
                                      ...
                                      corrector_kwargs=corrector_kwargs, down_samples=down_samples,
                                      unconditional_guidance_scale=unconditional_guidance_scale,
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None, down_samples=None,
                      unconditional_guidance_scale=1., unconditional_conditioning=None,**kwargs):
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            # print("==============")
            # print(down_samples)
            e_t = self.model.apply_model(x, t, c, down_samples=down_samples)
        else:
            x_in = torch.cat([x] * 2)
            t_in = torch.cat([t] * 2)
